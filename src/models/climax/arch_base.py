...
from scenarIA.src.models.climax.pos_embed import (
    get_1d_sincos_pos_embed_from_grid,
    get_2d_sincos_pos_embed,
)

from scenarIA.src.models.climax.parallelpatchembed import ParallelVarPatchEmbed
        ...
        self.blocks = nn.ModuleList(
            [
                Block(
                    ...
                    attn_drop=drop_rate, # modified for new timm version
                    proj_drop=drop_rate # modified for new timm version
                )
